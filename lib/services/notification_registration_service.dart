...
import 'package:notify_me/services/device_installation_service.dart';
import 'package:notify_me/models/device_installation.dart';
import 'package:flutter_secure_storage/flutter_secure_storage.dart';

class NotificationRegistrationService {
  static const notificationRegistration =
      MethodChannel('com.bizbox.notifyme/notificationregistration');
  ...
  Future<void> deregisterDevice() async {
    ...
    var response = await http.delete(
      Uri.parse('$installationsUrl/$deviceId'),
